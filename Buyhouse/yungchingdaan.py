...
url_2 = "https://buy.yungching.com.tw/region/台北市-大安區_c/-5000_price/?pg=100000"
...
for k in range(1,page):
    url = "https://buy.yungching.com.tw/region/台北市-大安區_c/-5000_price/pg=3?pg="+str(k)
...
for i in range(len(project_name)):
    Taipei.append({"Name":project_name[i],"Address":Address[i],"Price":prices[i],"Year":Year[i],"Area":Area[i],"Pattern":Pattern[i],"Store":"永慶"})
...
print("yungching daan data updated")
