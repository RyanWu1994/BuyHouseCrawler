...
url = "https://www.sinyi.com.tw/buy/list/5000-down-price/NewTaipei-city/220-zip/Taipei-R-mrtline/03-mrt/default-desc/"
...
for j in range (len(new_name)):
    banqiao_data.append({"Store":"信義", "Name":new_name[j], "Address":new_address[j], "Price":new_price[j], "Year":new_year[j], 
...
print("XinYi Banqiao data updated!!")
