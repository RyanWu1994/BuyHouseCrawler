...
url_2 = "https://buy.yungching.com.tw/region/新北市-板橋區_c/-5000_price/?pg=100000"
...
for k in range(1,page):
    url = "https://buy.yungching.com.tw/region/新北市-板橋區_c/-5000_price/pg=3?pg="+str(k)
...
for i in range(len(project_name)):
    NewTaipei.append({"Name":project_name[i],"Address":Address[i],"Price":prices[i],"Year":Year[i],"Area":Area[i],"Pattern":Pattern[i],"Store":"永慶"})
...
print("yungching Banqiao data updated")
